...
function Occam() {
  return (
    <svg viewBox="0 0 320 180" className={styles.svg} fill="none">
      ...
      <path d="M155 95 L300 95" stroke="var(--ember)" strokeWidth="4" />
      <circle cx="155" cy="95" r="5" fill="var(--ember)" />
    </svg>
  );
}
...
function Overfit() {
  return (
    <svg viewBox="0 0 320 180" className={styles.svg} fill="none">
      ...
      />
      <path d="M150 90 L165 70 L158 95 L175 85" stroke="var(--ember)" strokeWidth="2.5" />
      <circle cx="95" cy="55" r="5" fill="var(--muted)" />
      <circle cx="210" cy="50" r="5" fill="var(--muted)" />
      <circle cx="260" cy="120" r="5" fill="var(--muted)" />
      <circle cx="70" cy="110" r="4" fill="var(--ink)" />
      <circle cx="180" cy="130" r="4" fill="var(--ink)" />
    </svg>
  );
}
